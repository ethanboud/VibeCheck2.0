...
// import { LikedSongs } from "../../models/liked-songs.js";
...
// GET /songs/liked - Get liked songs for logged-in user
// router.get("/liked", async (req: Request, res: Response) => {
//   if (!req.user) {
//     return res.status(401).json({ message: "User not authenticated" });
//   }
//   const userId = req.user.username; // Assuming user ID is stored in req.user
//   try {
//     const likedSongs = await LikedSongs.findAll({
//       where: { assignedUserId: userId },
//       include: [
//         {
//           model: Song,
//           attributes: ["title", "artist", "id", "assignedUserId"], // Adjust attributes as necessary
//         },
//       ],
//     });
//     return res.json(likedSongs.map((song) => song.assignedUserId));
//   } catch (error: any) {
